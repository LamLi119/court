...
// Hide standard POIs but KEEP transit labels/icons
const MAP_STYLES = [
...
const MapView: React.FC<MapViewProps> = ({ venues, selectedVenue, onSelectVenue, language, darkMode }) => {
    ...
    useEffect(() => {
        ...
        // Clean up markers for venues no longer in view
    ...
    useEffect(() => {
        if (selectedVenue && googleMap.current) {
